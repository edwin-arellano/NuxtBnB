<template>
  <div>
    <div style="display:flex;">
      <img v-for="image in home.images" :key="image" :src="image" width="200" alt="Description...">
    </div>
    {{ home.title }}<br>
...
export default {
  head() {
    return {
      ...
      script: [
        {
          src: "https://maps.googleapis.com/maps/api/js?key=AIzaSyCZD-USouzDGDgXNHcQi8r8UtPlo28d_mQ&libraries=places",
          hid: "map",
          defer: true
        }
      ]
